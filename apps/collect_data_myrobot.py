                    ...
                    if os.path.abspath(png_path) != os.path.abspath(target):
                        try:
                            ...
                            try:
                                ...
                                pass
                        # If source still exists for any reason, remove it to avoid leaving png in CSV folder
                        try:
                            if os.path.exists(png_path) and os.path.abspath(png_path) != os.path.abspath(target):
                                os.remove(png_path)
                        except Exception:
                            pass
                    else:
                        # png already at target path; nothing to do
                        pass
