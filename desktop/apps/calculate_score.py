#!/usr/bin/env python
# uv run python apps/calculate_score.py -v data/trained_model/test/20250831T151315/trained_model.joblib -d ../20241203T144115/step/sync/{slow,middle,fast} --test-size 0.1 --split-in-each-directory --seed 42  -e pdf  
    ...
    *,
    ...
    for i, joint_index in enumerate(joints):
        ...
        for col, label in zip(cols, labels, strict=True):
            # Plot raw ca/cb values without additional scaling
