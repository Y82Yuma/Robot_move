#!/usr/bin/env python
"""export PYTHONPATH=/mnt/c/Users/HosodaLab2/University/Reserch/reservoir/myrobot/src
uv run python apps/train_esn_model.py /mnt/c/Users/HosodaLab2/University/Reserch/reservoir/myrobot/hirai/data/myrobot/hirai/csv/20250831/step/fast -m apps/config/model.toml --train-size 0.8 --seed 42 -a preview-ref -s std --include-tension -v
"""
