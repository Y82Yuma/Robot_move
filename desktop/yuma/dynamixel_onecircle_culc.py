import numpy as np
from model_new import ESN, Tikhonov
import os
...
# 教師データの作成
u = angles[:-1]  # 入力データ (t時刻の関節角度)
d = angles[1:]   # 出力データ (t+1時刻の関節角度)
...
# 学習後の重みを保存
weights_file = os.path.join(data_directory, "esn_weights_onecircle.npy")
